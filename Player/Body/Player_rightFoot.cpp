...
Player_rightFoot::Player_rightFoot(GameScene* _gameScene)
{
	m_gameScene = _gameScene;
	m_model = RESOURCE.GetModel("Data/Player_rightFoot/Player_rightFoot.gltf");
	m_animeFlg = false;
	m_animeFrame = 0;
	m_addTime = 0.1f;
	m_turnAng = 15;
...
void Player_rightFoot::Update()
{
	PlayerManager& playerMan = m_gameScene->GetPlayerManager();
	m_worldMat = playerMan.GetPlayerRLeg().GetMat();

...
Enemy_rightLeg::Enemy_rightLeg(GameScene* _gameScene, Enemy* _enemy)
{
	m_gameScene = _gameScene;
	m_enemy = _enemy;

	m_worldMat = DirectX::XMMatrixIdentity(); 
	m_model = RESOURCE.GetModel("Data/Enemy/Zombie/Zombie_right_leg.gltf");
